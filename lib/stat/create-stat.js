		...
		options: {
			...
			validate: {
				payload: Joi.object({
					...
					teamA: Joi.object({
						name: Joi.string().allow("").description("First team's name"),
						players: Joi.array()
							.items(
								Joi.object({
									...
									ftm: Joi.number().required().description("The free throws made"),
									fta: Joi.number().required().description("The free throws attempted"),
									fouls: Joi.number().required().description("The fouls committed"),
								})
							)
							.required()
							.description("The players of first team"),
						...
						injuries: Joi.array()
							.items(Joi.string().required().description("The playerID of injured player"))
							.description("The injured players"),
					}).required(),
					teamB: Joi.object({
						name: Joi.string().allow("").description("Second team's name"),
						players: Joi.array()
							.items(
								Joi.object({
									playerId: Joi.string().required().description("The player's id"),
							...
							.required()
							.description("The players of second team"),
						substitutes: Joi.array()
							.items(
								Joi.object({
									playerId: Joi.string().required().description("The player's id"),
