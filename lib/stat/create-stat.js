                ...
                payload: Joi.object({
                    ...
                    teamA: Joi.object({
                        ...
                        players: Joi.array().items(Joi.object({
                            ...
                            threePointersMade: Joi.number().required().description('The 3PT field goals made'),
                            threePointersAttempted: Joi.number().required().description('The 3PT field goals attempted'),
                            ...
                            pointsScored: Joi.number().required().description('Total points scored')
