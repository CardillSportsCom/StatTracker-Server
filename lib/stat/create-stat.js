                ...
                payload: Joi.object({
                    ...
                    teamA: Joi.object({
                        ...
                        players: Joi.array().items(Joi.object({
                            ...
                            blocksAgainst : Joi.number().required().description('The blocks against'),
                            stealsAgainst : Joi.number().required().description('The steals agains'),
                        ...
                        substitutes: Joi.array().items(Joi.object({
                            ...
                            stealsAgainst : Joi.number().required().description('The steals agains'),
                            turnovers: Joi.number().required().description('The field goals attempted')                            
                        })).required().description('The substitutes of first team'),                         
                        injuries : Joi.array().items(
                            Joi.number().required().description('The playerID of injured player')
                            ).required.description('The injured players')
                    }).required(),
                    teamB: Joi.object({
