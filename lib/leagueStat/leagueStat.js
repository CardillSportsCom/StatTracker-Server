    ...
    var LeagueStats = [];
      ...
      for(var j = 0; j< leaguePlayers.length; j++){
          ...
          var playerAverageStats = {
            ...
            threePointersMade: (perGame * playerStats.sum("threePointersMade")/playerStats.length).toFixed(2),
            threePointersAttempted: (perGame * playerStats.sum("threePointersAttempted")/playerStats.length).toFixed(2),
