...
module.exports =[].concat(LogRoutes, LoginRoutes, RegisterRoutes, LeagueRoutes, PlayerRoutes, 
    TeamRoutes, GameRoutes, LeaguePlayerRoutes, LeagueTypeRoutes, TeamTypeRoutes, StatRoutes, 
    PlayerStatRoutes, PlayerCumulativeStatRoutes, GameStatRoutes, ScoreRoutes, LeagueStatRoutes);
